...
from spikelearn.bootstrapping import bootstrapping_analysis, df_shuffler, DAG_analysis

clf = LinearDiscriminantAnalysis()

analysis = lambda df, clf: pd.DataFrame(cross_validate(clf, df.values, df.reset_index().time, df.reset_index().trial, 
